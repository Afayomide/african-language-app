        ...
        <div className="flex h-24 items-center px-8 border-b-2 border-secondary/30">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-2xl font-black tracking-tighter text-foreground leading-none">Voice</span>
              <span className="text-xs font-black text-primary tracking-[0.2em] uppercase">Artist Portal</span>
            </div>
          </div>
        </div>
