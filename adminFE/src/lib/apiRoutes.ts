...
export const beAdminRoutes = {
  ...
  restoreDeletedUnitPhrase: (id: string, phraseId: string) => `${BE_API_URL}/admin/units/${id}/deleted-phrases/${phraseId}/restore`,
  ...
  phraseImages: (id: string) => `${BE_API_URL}/admin/phrases/${id}/images`,
  phraseImageLink: (id: string, linkId: string) => `${BE_API_URL}/admin/phrases/${id}/images/${linkId}`,
...
export const feAdminRoutes = {
  ...
  restoreDeletedUnitPhrase: (id: string, phraseId: string) => `/api/admin/units/${id}/deleted-phrases/${phraseId}/restore`,
  ...
  phraseImages: (id: string) => `/api/admin/phrases/${id}/images`,
  phraseImageLink: (id: string, linkId: string) => `/api/admin/phrases/${id}/images/${linkId}`,
