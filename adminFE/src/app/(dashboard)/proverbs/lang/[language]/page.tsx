...
export default function AdminProverbsByLanguagePage({ params }: { params: Promise<{ language: string }> }) {
        ...
        <div className="flex items-center gap-2">
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Proverbs are reusable and can be mapped to lessons.</DialogDescription>
            </DialogHeader>
