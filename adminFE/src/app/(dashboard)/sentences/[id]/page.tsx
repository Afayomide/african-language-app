  ...
  async function loadDependencies() {
    try {
      ...
      const [lessonData, wordData, expressionData] = await Promise.all([
        mode === "edit" ? lessonService.listLessons(undefined, activeLanguage) : Promise.resolve([]),
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {mode === "edit" && id ? (
          <div className="flex gap-2">
            ...
            {sentence.status === "finished" ? <Button variant="outline" onClick={handleStatusAction}><CheckCircle className="mr-2 h-4 w-4" />Publish</Button> : null}
          </div>
        ) : null}
      </div>
