    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-extrabold tracking-tight text-foreground">{getLanguageName(language)} Sentences</h1>
            <p className="font-medium text-muted-foreground">Manage sentences for {getLanguageName(language)}.</p>
          </div>
        </div>
