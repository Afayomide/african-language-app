...
export default function SentencesByLanguagePage({ params }: { params: Promise<{ language: string }> }) {
  ...
  async function loadItems() {
    setIsLoading(true);
    try {
      const result = await sentenceService.listSentencesPage({ lessonId: selectedLessonId === "all" ? undefined : selectedLessonId, status: statusFilter === "all" ? undefined : statusFilter, language, q: search || undefined });
