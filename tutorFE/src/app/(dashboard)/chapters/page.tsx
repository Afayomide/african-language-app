...
import { authService, chapterService } from "@/services";
import { Chapter, Level, Status } from "@/types";
...
export default function ChaptersPage() {
  ...
  const loadChapters = useCallback(async () => {
    try {
      setIsLoading(true);
      const data = await chapterService.listChapters(status === "all" ? undefined : status);
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground font-medium">Build units and lessons under explicit chapter sections for {tutor?.language || "your"} curriculum.</p>
        </div>
      ...
      <Card>
        <CardHeader className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <CardDescription>Units and lessons should be managed from chapter context.</CardDescription>
          </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Chapters are the curriculum parent for units and lessons in your language.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input value={String(tutor?.language || "").toUpperCase()} disabled />
            </div>
            <div className="space-y-2">
              <Label>Level</Label>
      ...
      <Dialog open={isAiDialogOpen} onOpenChange={setIsAiDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Generate draft chapters for your tutor language. Use the theme field to steer the chapter set.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. greetings, travel, daily routines"
              />
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="e.g. Make the chapter sequence practical and conversation-first."
              />
            </div>
          </div>
          <DialogFooter>
