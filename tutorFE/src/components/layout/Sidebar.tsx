...
import { LayoutDashboard, BookOpen, MessageSquare, Settings, LogOut, Mic, MessageSquareQuote, FolderTree, LayoutGrid, Type, ScrollText } from "lucide-react"
...
const menuItems = [
  ...
  { name: "Expressions", href: "/expressions", icon: MessageSquare },
  { name: "Sentences", href: "/sentences", icon: ScrollText },
        ...
        <div className="flex h-20 items-center border-b px-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-semibold leading-none text-foreground">Tutor</span>
