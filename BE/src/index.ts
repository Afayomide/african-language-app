...
import adminLanguageRouter from "./routes/admin/language.routes.js";
...
import adminCurriculumAgentRouter from "./routes/admin/curriculumAgent.routes.js";
...
import tutorLanguageRouter from "./routes/tutor/language.routes.js";
...
app.use("/api/admin/ai/curriculum-jobs", adminCurriculumAgentRouter);
...
app.use("/api/tutor/languages", tutorLanguageRouter);
