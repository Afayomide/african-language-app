...
export function buildUnitPlanPrompt(input: {
  ...
  return [
    ...
    "- Each sentenceGoal is the English TEXT of one sentence the learner will actually say, written out as that sentence. It is not a description of what the learner can do -- that is what conversationGoal is for.",
    "- Write the utterance, not a description of it. \"Thank you, how are you?\" is a sentence goal. \"Say thank you and ask how they are\" is a description of a sentence goal, and is wrong.",
    "- More of the same mistake, all wrong because they describe instead of quote: \"Greet someone in the morning\", \"Answer a check-in with gratitude\", \"Ask how someone is\". Write \"Good morning\", \"I am fine, thank you\", \"How are you?\" instead.",
    ...
    "- Return 1 to 5 sentenceGoals. Return only as many distinct meanings as the lesson genuinely teaches, and do not pad the list with repeats or fragments.",
